...
2. Clone localmente: `git clone https://github.com/SEUNOMEDEUSUARIO/dio-lab-open-source.git`;
...
4. Crie/Referêncie uma nova **branch** e nomeie como `feat/community/SEU_USERNAME`: `git checkout -b feat/community/promyr`;
    > Exemplo: `git checkout -b feat/community/promyr`
